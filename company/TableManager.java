...
public class TableManager {
    ...
    public static void Operate(String conmand)
    {
        ...
        }else if(judge_Select2(conmand.toLowerCase()))
        {
            ...
            else
            {
                ...
                {
                    System.out.println("输入的数据： "+data[unsafe_data]+" 不存在于数据表"+filename+"中");
                }
        ...
        else if(judge_Select3(conmand.toLowerCase()))
        {

            String Conmand1=conmand.substring(conmand.indexOf("from ")+5,conmand.length());
            String filename=Conmand1;

            String Conmand2=conmand.substring(conmand.indexOf("select ")+7,conmand.indexOf(" from"));
            String[]data=Conmand2.split(", ");
            int flag=1;
        ...
        else if(judge_Select4(conmand.toLowerCase()))
        {
    ...
    {
        if(comand.indexOf("select")!=-1&&comand.indexOf("from")!=-1&&comand.indexOf("where")!=-1&&comand.indexOf("*")==-1)
            return true;
        return false;
    }
    public static boolean judge_Select3(String comand)
    {
        if(comand.indexOf("select")!=-1&&comand.indexOf("from")!=-1&&comand.indexOf("*")==-1)
            return  true;
        return false;
    }
    public static boolean judge_Select4(String comand)
    {
        if(comand.indexOf("select")!=-1&&comand.indexOf("where")!=-1&&comand.indexOf("*")!=-1)
            return  true;
        return false;
    }
...
//        System.out.println(V3);
    ...
    public static void selete(String filename,String[] date)throws IOException {
